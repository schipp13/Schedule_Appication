...
namespace Scheduling_Application.Views
{
    public partial class appointmentForm : Form
    {
        ...
        public bool appointmentInfoValidator()
        {
            bool valid = true;
        ...
        private void applyButton_Click(object sender, EventArgs e)
        {
            ...
            bool validFields = appointmentInfoValidator();
            ...
            if (validFields)
            {
                ...
                if (withinBusinessHours == true)
                {
                    ...
                    found = dbController.existQuery($"SELECT * FROM appointment WHERE start = '{combinedStartDateTime.ToUniversalTime().ToString(formatted)}'");
